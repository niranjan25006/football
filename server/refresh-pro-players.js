...
async function refresh() {
    ...
    const proPlayers = [
        ...
        { name: 'Kevin De Bruyne', age: 32, position: 'Midfielder', number: 17, height: '1.81m', preferredFoot: 'Right', nationality: 'Belgium', image: 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&q=80&w=800', goals: 5, assists: 15, matchesPlayed: 18 },
        { name: 'Erling Haaland', age: 23, position: 'Forward', number: 9, height: '1.94m', preferredFoot: 'Left', nationality: 'Norway', image: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&q=80&w=800', goals: 18, assists: 2, matchesPlayed: 22 },
        ...
        { name: 'Virgil van Dijk', age: 32, position: 'Defender', number: 4, height: '1.93m', preferredFoot: 'Right', nationality: 'Netherlands', image: 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&q=80&w=800', goals: 2, assists: 1, matchesPlayed: 24 },
        ...
        { name: 'Manuel Neuer', age: 37, position: 'Goalkeeper', number: 1, height: '1.93m', preferredFoot: 'Right', nationality: 'Germany', image: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&q=80&w=800', goals: 0, assists: 0, matchesPlayed: 25 }
    ];
